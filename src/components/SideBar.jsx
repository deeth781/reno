    ...
    <section
      ...
      <div className='flex items-center justify-between w-full px-2 mx-auto'>
        <div
          ...
          <h1 className={` ${!open && 'scale-0 hidden'}`}>Reno Bot</h1>
        </div>
        <div
      ...
      <ul className='w-full menu rounded-box'>
        <li>
          <a className='border border-slate-500' onClick={clear}>
            <MdDelete size={15} />
            <p className={`${!open && 'hidden'}`}>Dọn Cuộc Trò Chuyện</p>
          </a>
        </li>
      </ul>
      ...
      <ul className='absolute bottom-0 w-full gap-1 menu rounded-box'>
        ...
        <li>
          <a
            href='https://www.facebook.com/profile.php?id=61557573912869'
            rel='noreferrer'
            target='_blank'>
            <MdOutlineCoffee size={15} />
            <p className={`${!open && 'hidden'}`}>Theo Dõi Facebook</p>
          </a>
        </li>
        <li>
          <a
            rel='noreferrer'
            target='_blank'
            href='https://github.com/deeth781'>
