...
const template = [
  {
    title: 'Kế hoạch cho một chuyến đi',
    prompt: 'Tôi muốn lên kế hoạch cho một chuyến đi đến Thành phố New York.',
  },
  {
    title: 'cách làm bánh',
    prompt: 'Cách làm bánh với sô cô la và dâu tây?',
  },
  {
    title: 'Ý tưởng kinh doanh',
    prompt: 'Tạo ra 5 ý tưởng kinh doanh cho một công ty khởi nghiệp mới.',
  },
  {
    title: 'Đệ quy là gì?',
    prompt: 'Đệ quy là gì? chỉ cho tôi một ví dụ về python.',
  },
];
